...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    #loss1=  scores-y
    #print(loss1.shape)
    loss = data_loss/num_train + reg*np.sum(W1 * W1)/2 +reg*np.sum(W2 * W2)/2
    ##############################  ###############################################
    #                              END OF YOUR CODE                             #
    #############################################################################
    ...
    dscores /= num_train
    #print(dscores.shape)
    grads['W2'] = a_1.T.dot(dscores) + reg * W2
  ...
  def predict(self, X):
    ...
    a_1 = np.maximum(0, z_1)
    scores =  a_1.dot(self.params['W2'])+self.params['b2']
